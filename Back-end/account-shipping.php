...
<body>
    ...
    <div class="navmydiv">
        ...
        <div>
            <div class="main-div">
                <div class="minidiv">
                    <div class="myship">My shipping address</div>
                    <div class="adress"><button class="address">Add a new Address</button></div>
                </div>
            ...
            <div class="divi">
                <div class="shipinfo">
                    <div class="idiv">
                        <div class="icon"><i class="fa-solid fa-user" id="fa-solid"></i></div>
                        <div class="icon-name">Vanessa Chebukwa</div>
                    </div>
                    <div class="idiv">
                        <div><i class="fa-solid fa-phone" id="fa-solid"></i></div>
                        <div class="icon-name">+254798812578</div>
                    </div>
                    <div class="idiv">
                        <div class="icon" id="fa-solid"><i class="fa-solid fa-location-dot" id="fa-solid"></i></div>
                        <div class="icon-name" >KNH-Administration Block <br><br> KNH Hostels 1.24
                            <br><br>
                            Nairobi ,Kenya
                            <br><br> 738800100
                        </div>
