...
<body>
    ...
    <div class="navmydiv">
        ...
        <div>
            <div class="main-div">
                <div class="heading">
                    <div class="manage">Manage Feedback</div>
                    <div class="guidelines">Guidelines</div>
                </div>
                <div class="malorem">
                    <div class="lorem">1.Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet, vero.</div>
                    <div class="lorem">2.Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet, vero.</div>
                    <div class="lorem">3.Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet, vero.</div>
                </div>
            </div>
            ...
            <div class="divi">
                <div class="mydivi">
                    <nav class="mynav">
                        <ul>
                            <li><a href="">Orders awaiting my review</a></li>
                            <li><a href="">Reviews by me</a></li>
                        </ul>
                    </nav>
                </div>
                <div class="mydivi2">
