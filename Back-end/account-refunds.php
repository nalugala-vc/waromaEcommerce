...
<body>
    ...
    <div class="navmydiv">
        ...
        <div>
            <div class="heada1">
                <div class="refunds">Refunds & Returns</div>
            ...
            <div class="heada2">
                <nav class="minnav1">
                    <ul>
                        <li><a href="">In Progress(0)</a></li>
                        <li><a href="">Awaiting items return(0)</a></li>
                    </ul>
                </nav>
            ...
            <div class="boddy">
                <nav class="minnav2">
                    <ul>
                        ...
                        <li><a href="">Status of all returns and refunds</a></li>
                    </ul>
                </nav>
                <div class="no">No orders to return and refund yet</div>
