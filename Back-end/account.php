...
<body>
    ...
    <div class="navmydiv">
        ...
        <div>
            <div class="main-div">
                <div class="acc-greet"><img src="account2.png" alt="" id="img-acc">
                    <?php echo "Hi ".$Username?>
                </div>
            
                <div class="main-icons">
                    <div>
                        <a href="account(overview)-wishlist.php">
                            <div class="icon"><i class="fa-solid fa-bag-shopping"></i></div>
                            <div class="icon-name i1">wishlist</div>
                        </a>
                    </div>
                    <div>
                        <a href="account(overview)-following.php">
                            <div class="icon"><i class="fa-solid fa-user"></i></div>
                            <div class="icon-name i2">Following</div>
                        </a>
                    </div>
                    <div>
                        <a href="account(overview)-viewed.php">
                            <div class="icon"><i class="fa-solid fa-clock"></i></i></div>
                            <div class="icon-name i3">Purchased</div>
                        </a>
                    </div>
                    <div>
                        <a href="account(overview)-inbox.php">
                            <div class="icon"><i class="fa-solid fa-envelope"></i></div>
                            <div class="icon-name i4">inbox</div>
                        </a>
                    </div>
                </div>
            </div>
            <div class="divi">
                <div class="h5"><h5 >My Orders</h5></div>
            
                <div class="icon-con">
                    <div>
                        <a href="account-orders.php">
                            <div><i class="fa-solid fa-wallet"></i></div>
                            <div class="name-icon">Unpaid</div>
                        </a>
                    </div>
                    <div>
                        <a href="account-orders.php">
                            <div><i class="fa-solid fa-ship"></i></i></div>
                            <div class="name-icon">To be shipped</div>
                        </a>
                    </div>
                    <div>
                        <a href="account-orders.php">
                            <div><i class="fa-solid fa-truck"></i></div>
                            <div class="name-icon">Shipped</div>
            
                        </a>
                    </div>
                </div>
                <div class="icon-conn">
                    <a class="myiconz" href="account-refunds.php">
                        <div class="conn1">
                            <div><i class="fa-solid fa-book"></i></div>
                            <div class="con-name">My Appeal</div>
                        </div>
                        <div class="conn2">
                            <div><i class="fa-solid fa-dollar-sign"></i></div>
                            <div class="con-name">In dispute</div>
                        </div>
                    </a>
                </div>
            </div>
