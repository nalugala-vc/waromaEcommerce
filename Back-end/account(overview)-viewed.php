...
<?php
    ...
    $sql=mysqli_query($conn,"SELECT * FROM `bought items` WHERE UserID='$Userid'");
...
<head>
    ...
    <link rel="stylesheet" href="acccount-orders.css?v=<?php echo time();?>">
</head>
...
<body>
    ...
    <div class="navmydiv">
        ...
        <div>
            <div class="nav2">
                <div class="rviewed">Recently Purchased items</div>
            </div>
            ...
            <div class="containerr">
                <?php while($row=mysqli_fetch_array($sql))
                {
                    ?>
                <div class="productss">
                    <div class="product-img"><img class="product-img" src="includes/img/<?php echo $row['image'] ?>" alt=""></div>
                    <div class="product-name"><?php echo $row['name']?></div>
                    <div class="product-price"><?php echo "US $ ".$row['Price']?></div>
